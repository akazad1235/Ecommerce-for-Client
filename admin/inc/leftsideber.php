                    ...
                    <div id="sidebar-menu">
                        ...
                        <ul class="metismenu" id="side-menu">
                            ...
                            <li>
                                ...
                                <ul class="nav-second-level" aria-expanded="false">
                                    <li>
                                        <a href="ecommerce-dashboard.php">Dashboard</a>
                                    </li>
                                    <li>
                                        <a href="ecommerce-products.php">Products</a>
                                    </li>
                                    <li>
                                        <a href="ecommerce-prduct-detail.php">Product Detail</a>
                                    </li>
                                    <li>
                                        <a href="ecommerce-product-edit.php">Product Edit</a>
                                    </li>
                                    <li>
                            ...
                            <li>
                                ...
                                <ul class="nav-second-level" aria-expanded="false">
                                    ...
                                    <li>
                                        <a href="eco-addCategory.php">Add Category</a>
                                    </li>
                                    <li>
                                        <a href="eco-categoryList.php">Category List</a>
                                    </li>
                                </ul>
                            </li>
                            <li>
                                ...
                                <ul class="nav-second-level" aria-expanded="false">
                                    ...
                                    <li>
                                        <a href="eco-addBrand.php">Add Brand</a>
                                    </li>
                                    <li>
                                        <a href="eco-BrandList.php">Brand List</a>
                                    </li>
                                </ul>
                            </li>
                            <li>
